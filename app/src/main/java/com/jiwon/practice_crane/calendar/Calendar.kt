...
import com.jiwon.practice_crane.ui.theme.Circle
import com.jiwon.practice_crane.ui.theme.SemiRect
...
private fun DayContainer(
    ...
    val stateDescrptionLabel = stringResource(
    ...
    Surface(
        modifier = modifier
            ...
            .then(
                if (onClickEnabled) {
                    modifier.semantics {
                        stateDescription = stateDescrptionLabel
                    }
                } else {
