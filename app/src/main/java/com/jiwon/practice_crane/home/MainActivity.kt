...
import com.jiwon.practice_crane.calendar.launchCalendarActivity
import com.jiwon.practice_crane.details.launchDetailsActivity
import com.jiwon.practice_crane.ui.theme.CraneTheme
...
fun previewMain(){
    ProvideWindowInsets {
        ...
        CraneTheme {
            MainScreen(
                onExploreItemClicked = { launchDetailsActivity(context = context, item = it) },
                onDateSelectionClicked = { launchCalendarActivity(context) }
            )
        }
    }
}
...
private fun MainContent(
    ...
    Column(modifier = modifier) {
        ...
        CraneHome(
            modifier = modifier,
            onExploreItemClicked = onExploreItemClicked,
            onDateSelectedClicked = onDateSelectionClicked
        )
    }
}
